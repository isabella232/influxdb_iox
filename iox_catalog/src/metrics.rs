...
decorate!(
    ...
    methods = [
        ...
        "parquet_count_by_table_and_sequencer" = count_by_table_and_sequencer(&mut self, table_id: TableId, sequencer_id: SequencerId, min_time: Timestamp, max_time: Timestamp) -> Result<i64>;
    ]
);
