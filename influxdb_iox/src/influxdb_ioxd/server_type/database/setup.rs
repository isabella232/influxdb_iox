...
use iox_clap_blocks::object_store::{check_object_store, warn_about_inmem_store};
...
pub enum Error {
    ...
    ObjectStoreParsing {
        source: iox_clap_blocks::object_store::ParseError,
    },

    #[snafu(display("Cannot check object store config: {}", source))]
    ObjectStoreCheck {
        source: iox_clap_blocks::object_store::CheckError,
    },
}
